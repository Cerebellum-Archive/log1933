          ...
          <div className="relative">
            ...
            {journeyData.map((entry, index) => (
              <div key={index} className="relative mb-16 md:mb-24">
                {/* Timeline Dot */}
                <div className="absolute left-6 md:left-6 top-6 w-4 h-4 bg-blue-500 rounded-full border-4 border-slate-900 z-10"></div>
                
                {/* Content */}
                <div className="md:ml-16 bg-slate-800 rounded-lg p-6 md:p-8 hover:bg-slate-700 transition-colors">
